...
export function Navbar() {
  ...
  return (
    <>
      {/* Desktop top nav */}
      <nav className="app-nav-desktop hidden sm:block sticky top-0 z-50 backdrop-blur-md border-b border-white/5">
      ...
      <nav className="app-nav-mobile sm:hidden fixed bottom-0 left-0 right-0 z-50 backdrop-blur-md border-t border-white/5">
